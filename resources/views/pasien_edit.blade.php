    ...
    <div class="card-body">
        ...
        <form action="/pasien/{{ $pasien->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mt-1 mb-3">
                ...
                <img src="{{ \Storage::url($pasien->id) }}" alt="Foto Pasien" class="img-thumbnsil mt-2" style="width: 100px">
            </div>
            <div class="form-group mt-1mb-3">
            ...
            <div class="form-group mt-1mb-3">
                ...
                <span class="text-danger">{{ $errors->first('no_pasien') ?? $pasien->no_pasien }}</span>
            </div>
